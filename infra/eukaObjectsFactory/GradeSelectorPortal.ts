...
export enum GradeSelectorPortal {
...
export class GradeSelectorPortalDetails {
    gradeText: string;
    gradeLink: Locator;
    gradeLevel: string;
    productFamilyGradeID: string;

    constructor(page: Page, gradeLinkSelector: string, gradeLevel: string, gradeText: string, productFamilyGradeID: string) {
        this.gradeText = gradeText;
        this.gradeLink = page.locator(gradeLinkSelector);
    ...
    getGradeLink(): Locator {
        return this.gradeLink;
    }
}

function GradeSelectorPortalMap(page: Page): { [key in GradeSelectorPortal]: GradeSelectorPortalDetails } {
    return {
...
// Example usage:
// const gradeMap = GradeSelectorPortalMap(page);
// const selectedGrade = GradeSelectorPortal.GRADE_1;
// const gradeDetails = gradeMap[selectedGrade];
...
// gradeDetails.getGradeLink().click(); // Clicks on the grade element